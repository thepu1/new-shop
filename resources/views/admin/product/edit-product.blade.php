        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <div class="card my-5">
                    ...
                    <div class="card-body">
                        {{Form::open(['route' => 'update-product','method' => 'post','enctype' => 'multipart/form-data','name' => 'editProductForm'])}}
                        <div class="form-group row">
                            <label class="col-md-3" for="category_id">Category Name</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="hidden" class="form-control" name="id" id="" value="{{$product->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" name="product_price" id="product_price" value="{{$product->product_price}}">
                                <span class="text-center text-danger">{{$errors->has('product_price') ? $errors->first('product_price') : ''}}</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="product_tax" class="col-md-3">Product Tax :</label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" name="product_tax" id="product_tax" value="{{$product->product_tax}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="short_description" id="short_description" value="{{$product->short_description}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="long_description" id="long_description" value="{{$product->long_description}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="{{asset($product->product_image)}}" alt="" width="100" height="120">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="radio" {{$product->publication_status==1 ? 'checked' : '' }} name="publication_status" value="1" id="publication_status"> Published
                                <input type="radio" {{$product->publication_status==0 ? 'checked' : '' }} name="publication_status" value="0" id="publication_status"> Unublished <br>
