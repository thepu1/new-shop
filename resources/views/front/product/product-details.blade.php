                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <div class="color-quality">
                                    ...
                                    {{--</div>--}}
                                        ...
                                        <input type="number" id="number" name="qty" value="1" min="1" />
                                ...
                                <div class="women">
                                    ...
                                    <input type="submit" class="my-cart-b item_add" name="btn" value="Add to cart" style="color: #0d59af">
                                </div>
                                </form>
                        ...
                        <div class="col-md-4 product-grid">
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive " src="{{asset('/')}}front/assets/images/r4.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                                            <div class="block">
                                    ...
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive " src="{{asset('/')}}front/assets/images/r5.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
                                            <div class="block">
                            ...
                            <img class="img-responsive " src="{{asset('/')}}front/assets/images/woo2.jpg" alt="">
                        </div>
                                            ...
                                            <div class="descr">
                                                <div class="reviews-top">
                                                    <div class="reviews-left">
                                                        <img src="{{asset('/')}}front/assets/images/men3.jpg" alt=" " class="img-responsive">
                                                    </div>
