                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div class="product-tab">
                                            ...
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem" style="margin-bottom: 40px">
                                                <div class="grid-arr">
                                                    ...
                                                    <div class="women">
                                                        ...
                                                        <p ><del></del><em class="item_price">TK.{{$product->product_price}}</em></p>
                                                        <a href="{{route('product-details',$product->id)}}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        @foreach($products as $product)
                                        <div class="product-tab1" style="margin-top: 40px">
                                            <div class="col-md-4 product-tab1-grid">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{route('product-details',$product->id)}}" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($product->product_image)}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="grid-img">
