...
<div class="copy-section">
    <div class="container">
        ...
        <div class="copy-right">
            <img src="{{asset('/')}}front/assets/images/card.png" alt=""/>
        </div>
        <div class="clearfix"></div>
    </div>
</div>
                ...
                <div class="news-gr">
                    ...
                    <div class="col-md-7 new-grid">
                        ...
                        <div class="women">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="Kabuli Chana" data-summary="summary 3" data-price="2.00" data-quantity="1" data-image="{{asset('/')}}front/assets/images/of2.png">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
